...
(
	...
	-- для КМА устанавливаем формат и диапазоны печати для каждой из категории в соответствии с нормами обеспечения ВТ
	[idFormat] INT null,
	CONSTRAINT [FK_rBudgetSprav_rFormat] FOREIGN KEY (idFormat) REFERENCES rFormatPrinter(id),
	pmin int null,
	pmax int null
)
