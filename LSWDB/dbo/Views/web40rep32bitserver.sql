...
CREATE VIEW [dbo].[web40rep32bitserver]
AS
...
WHERE      (dbo.tblComputersystem.SystemType LIKE 'x86%') AND (dbo.tblComputersystem.Domainrole > 1) AND (dbo.tblAssetCustom.State = 1)
