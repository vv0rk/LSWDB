...
CREATE VIEW [dbo].[web40repdeviceoow60]
AS
...
WHERE      (dbo.tblAssetCustom.Warrantydate > GETDATE()) AND (dbo.tblAssetCustom.State = 1) AND (dbo.tblAssetCustom.Warrantydate < GETDATE() + 60) AND 
