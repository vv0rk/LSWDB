...
CREATE VIEW [dbo].[web40repservicesstoppedServer]
AS
...
WHERE      (dbo.tblComputersystem.Domainrole > 1) AND (dbo.tblServices.StartID = 3) AND (dbo.tblServices.StateID = 1) AND (dbo.tblAssetCustom.State = 1)
