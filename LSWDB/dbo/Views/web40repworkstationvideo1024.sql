...
CREATE VIEW [dbo].[web40repworkstationvideo1024]
AS
...
WHERE      (CEILING(dbo.tblVideoController.AdapterRAM / 1024 / 1024) < 1024) AND (dbo.tblComputersystem.Domainrole < 2) AND (dbo.tblAssetCustom.State = 1) 
