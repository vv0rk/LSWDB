...
CREATE VIEW [dbo].[web40repserviceMSSQL]
AS
SELECT      TOP 1000000 dbo.tblAssets.AssetID, dbo.tblAssets.AssetUnique, dbo.tblAssets.Domain, dbo.tsysOS.OSname, dbo.tblAssets.Description, 
                        dbo.tblServicesUni.Name, dbo.tblServices.Lastchanged, dbo.tsysOS.Image AS icon
...
WHERE      (dbo.tblServicesUni.Name = N'MSSQLSERVER' OR
                        dbo.tblServicesUni.Name LIKE N'MSSQL$%') AND (dbo.tblAssetCustom.State = 1)
