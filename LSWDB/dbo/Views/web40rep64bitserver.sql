...
CREATE VIEW [dbo].[web40rep64bitserver]
AS
...
WHERE      (dbo.tblComputersystem.SystemType LIKE 'x64%') AND (dbo.tblComputersystem.Domainrole > 1) AND (dbo.tblAssetCustom.State = 1)
