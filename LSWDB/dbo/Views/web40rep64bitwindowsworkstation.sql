...
CREATE VIEW [dbo].[web40rep64bitwindowsworkstation]
AS
...
WHERE      (dbo.tblComputersystem.SystemType LIKE 'x64%') AND (dbo.tblComputersystem.Domainrole < 2) AND (dbo.tblAssetCustom.State = 1)
