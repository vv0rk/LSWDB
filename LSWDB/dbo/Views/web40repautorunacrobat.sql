...
CREATE VIEW [dbo].[web40repautorunacrobat]
AS
...
WHERE      (dbo.tblAutorunUni.Caption LIKE N'acrobat%' OR
                        dbo.tblAutorunUni.Caption LIKE N'adobe%') AND (dbo.tblAssetCustom.State = 1)
