...
CREATE VIEW [dbo].[web40repservOOwarranty]
AS
...
WHERE      (dbo.tblAssetCustom.Warrantydate < GETDATE()) AND (dbo.tblComputersystem.Domainrole > 1) AND (dbo.tblAssetCustom.State = 1)
