...
CREATE VIEW [dbo].[web40repdeviceoow30]
AS
...
WHERE      (dbo.tblAssetCustom.State = 1) AND (dbo.tblAssetCustom.Warrantydate > GETDATE()) AND (dbo.tblAssetCustom.Warrantydate < GETDATE() + 30) AND 
